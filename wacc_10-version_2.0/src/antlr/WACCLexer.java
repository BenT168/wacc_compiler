...
public class WACCLexer extends Lexer {
	...
	public static final int
		...
		CLOSE_SQUARE=29, INTEGER=30, BEGIN=31, END=32, IS=33, SKIP_STATEMENT=34, 
		READ=35, FREE=36, RETURN=37, EXIT=38, PRINTLN=39, PRINT=40, NULL=41, COMMENT=42, 
		...
		WHITESPACE=70, APOSTROPHE=71, IDENTIFIER=72, CHAR_LITER=73;
	...
	public static final String[] ruleNames = {
		...
		"DIGIT", "INTEGER", "BEGIN", "END", "IS", "SKIP_STATEMENT", "READ", "FREE", 
		...
		"ANY_CHAR", "ID_BEGIN_CHAR", "ID_CHAR", "IDENTIFIER", "CHAR_LITER"
	};
