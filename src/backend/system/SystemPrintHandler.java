...
public static Token PRINT_STRING = new Token() {
		...
		public TokenSequence toPrepend() {
			return new TokenSequence(SystemFormatterHandler.STRING_FORMATTER);
		}
	...
	public static Token PRINT_LN = new Token() {
		...
		public TokenSequence toPrepend() {
			return new TokenSequence(SystemFormatterHandler.NEW_LINE_FORMATTER);
		}
	...
	public static Token PRINT_BOOL = new Token() {
		...
		public TokenSequence toPrepend() {
			return new TokenSequence(SystemFormatterHandler.BOOL_FORMATTER);
		}
	...
	public static Token PRINT_REF = new Token() {
		public TokenSequence toPrepend() {
			return new TokenSequence(SystemFormatterHandler.REFERENCE_FORMATTER);
		}
