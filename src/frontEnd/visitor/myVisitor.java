...
import frontEnd.semanticCheck.DebugError;
...
public class myVisitor extends WACCParserBaseVisitor<ASTTree> {
    ...
    private static final DebugError debugError = new DebugError();
    ...
    @Override
    public ASTTree visitMultipleStat(WACCParser.MultipleStatContext ctx) {
	Stat lhs = (Stat) visit(ctx.stat(0));
	Stat rhs = (Stat) visit(ctx.stat(1));
	SeqStat seqStat = new SeqStat(lhs, rhs);
    ...
    public ASTTree visitAssign(@NotNull WACCParser.AssignContext ctx) {
        ...
        Expr rhs = (Expr) visit(ctx.assignRHS());
...
//..................................ASSIGNMENT......................................
   // Function Call context cant be found
    public ASTTree visitCall(WACCParser.CallContext ctx) {
    ...
    @Override
    public ASTTree visitNewPair(WACCParser.NewPairContext ctx) {
	Expr fst = (Expr) visit(ctx);
	Expr snd = (Expr) visit(ctx);
    ...
    public ASTTree visitIntLiter(WACCParser.IntLiterContext ctx) {
        ...
        IntLiter intLeaf = new IntLiter(intValue);
